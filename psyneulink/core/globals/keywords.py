...
__all__ = [
    ...
    'MODEL_SPEC_ID_SENDER_MECH', 'MODEL_SPEC_ID_SENDER_STATE', 'MODEL_SPEC_ID_RECEIVER_MECH', 'MODEL_SPEC_ID_RECEIVER_STATE',
    'MODEL_SPEC_ID_PARAMETER_SOURCE', 'MODEL_SPEC_ID_PARAMETER_VALUE',
...
MODEL_SPEC_ID_SENDER_STATE = 'sender port'
MODEL_SPEC_ID_RECEIVER_MECH = 'receiver'
MODEL_SPEC_ID_RECEIVER_STATE = 'receiver port'
